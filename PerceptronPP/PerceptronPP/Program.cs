...
internal static class Program
{
	...
	public static void Main()
	{
		...
		using var mnist = new IdxReader(Path.Combine("..", "..", "..", "..", "Datasets", "MNIST", "train-images.idx3-ubyte"));
		using var mnist2 =
			new IdxReader(Path.Combine("..", "..", "..", "..", "Datasets", "MNIST", "train-labels.idx1-ubyte"));
		...
		var sorted = labeledImages.OrderBy(x => x.Item1).Select(tuple =>
			Tuple.Create(Learning.IntToExpectedOutputArray(tuple.Item1), tuple.Item2));
